...
namespace APSDataAccessLibrary.Migrations
{
    ...
    [Migration("20220527152504_withBuilder")]
    partial class withBuilder
    {
            ...
            modelBuilder.Entity("APSDataAccessLibrary.Models.ParkingLot", b =>
                {
                    b.HasOne("APSDataAccessLibrary.Models.Vehicle", "Vehicle")
                        .WithOne("ParkingLot")
                        .HasForeignKey("APSDataAccessLibrary.Models.ParkingLot", "VehicleId");
            ...
            modelBuilder.Entity("APSDataAccessLibrary.Models.User", b =>
                {
                    b.HasOne("APSDataAccessLibrary.Models.Vehicle", "Vehicle")
                        .WithOne("Owner")
                        .HasForeignKey("APSDataAccessLibrary.Models.User", "VehicleId");
